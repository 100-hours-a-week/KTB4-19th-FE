...
export function WifiIcon({ online }: { online: boolean }) {
  return (
    ...
    >
      <path
        d="M7.5 2.2c2.1 0 4 .8 5.5 2.1l1.2-1.3A9.9 9.9 0 0 0 7.5.4 9.9 9.9 0 0 0 .8 3l1.2 1.3a8.1 8.1 0 0 1 5.5-2.1Z"
        fill="currentColor"
      />
      <path
        d="M7.5 5.5c1.2 0 2.3.4 3.2 1.2l1.2-1.3a6.5 6.5 0 0 0-8.8 0l1.2 1.3c.9-.8 2-1.2 3.2-1.2Z"
        fill="currentColor"
      />
      <path
        d="M7.5 8.6c.5 0 .9.2 1.2.4L7.5 10.4 6.3 9c.3-.2.7-.4 1.2-.4Z"
        fill="currentColor"
      />
    </svg>
  );
...
export function BatteryIcon({ battery }: { battery: BatteryStatus }) {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M23 4v4c.8-.3 1.3-1.1 1.3-2s-.5-1.7-1.3-2Z"
        fill="currentColor"
        opacity="0.4"
      />
    </svg>
