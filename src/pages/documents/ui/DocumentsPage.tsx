import { IconDocumentLine, IconMagnifyingglassLine, IconPlusLine } from "@karrotmarket/react-monochrome-icon";
...
export function DocumentsPage({ state }: { state: ViewState }) {
